...
//                                  app 配置                                       //
//*********************************************************************************//
#define TCFG_APP_BT_EN			            1     //蓝牙
#define TCFG_APP_MUSIC_EN			        1    //u盘
#define TCFG_APP_LINEIN_EN					0
#define TCFG_APP_FM_EN					    0
#define TCFG_APP_PC_EN					    0
#define TCFG_APP_RTC_EN					    1  // 假时钟
...
// 第二组
// #define TCFG_ADKEY_PORT2                    IO_PORTB_04         //AD按键端口(需要注意选择的IO口是否支持AD功能)
// #define TCFG_ADKEY_AD_CHANNEL2              AD_CH_PB4
...
#define TCFG_ADKEY_AD0      (0x3ffL * 10   / (10    + R_UP))     //1K
#define TCFG_ADKEY_AD1      (0x3ffL * 20   / (20    + R_UP))     //2K
#define TCFG_ADKEY_AD2      (0x3ffL * 33   / (33    + R_UP))     //3.3k
#define TCFG_ADKEY_AD3      (0x3ffL * 51   / (51    + R_UP))     //5.1k
#define TCFG_ADKEY_AD4      (0x3ffL * 75   / (75    + R_UP))     //7.5k
#define TCFG_ADKEY_AD5      (0x3ffL * 100  / (100   + R_UP))     //10k
#define TCFG_ADKEY_AD6      (0x3ffL * 120  / (120   + R_UP))     //12k
#define TCFG_ADKEY_AD7      (0x3ffL * 150  / (150   + R_UP))     //15k
#define TCFG_ADKEY_AD8      (0x3ffL * 200  / (200   + R_UP))     //20K
#define TCFG_ADKEY_AD9      (0x3ffL * 330  / (330   + R_UP))     //33k
#define TCFG_ADKEY_AD10     (0x3ffL * 560  / (560   + R_UP))     //56k
#define TCFG_ADKEY_VDDIO     (0x3ffL)
...
// #define TCFG_LOWPOWER_VDDIOM_LEVEL			VDDIOM_VOL_24V
...
#define TCFG_USER_BT_CLASSIC_ENABLE         1   //经典蓝牙功能使能     蓝牙音乐功能开关
...
#define USER_SUPPORT_PROFILE_HFP    1   // 蓝牙通话开关
#define USER_SUPPORT_PROFILE_A2DP   1   // 蓝牙音乐功能开关
#define USER_SUPPORT_PROFILE_AVCTP  1   // 蓝牙音乐功能开关
...
#define TCFG_USE_VIRTUAL_RTC                   1//ENABLE    //假时钟
