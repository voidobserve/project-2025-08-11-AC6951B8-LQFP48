...
//是否支持拔出充电自动开机功能
#define TCFG_CHARGE_OFF_POWERON_NE			0
...
#define    TUYA_MULTI_BLE_EN         0//TUYA BLE多机使能
...
//蓝牙BLE多连接
#if TUYA_MULTI_BLE_EN                  //TUYA BLE多连:1主1从,或者2主
#define TRANS_MULTI_BLE_SLAVE_NUMS        1 //range(0~1)
#define TRANS_MULTI_BLE_MASTER_NUMS       1 //range(0~2)
#endif
...
//                                  REC 配置                                       //
//*********************************************************************************//
#define RECORDER_MIX_EN						0//TCFG_APP_RECORD_EN//混合录音使能
...
#define TCFG_ENC_MP3_ENABLE                ENABLE//DISABLE
#define TCFG_ENC_ADPCM_ENABLE              DISABLE
#define TCFG_ENC_PCM_ENABLE                ENABLE//DISABLE
#define TCFG_ENC_SBC_ENABLE                DISABLE
#define TCFG_ENC_OPUS_ENABLE               ENABLE//DISABLE
...
#if ((TCFG_MIC_EFFECT_ENABLE || RECORDER_MIX_EN) && (BT_MIC_EN))
#error "第三方应用平台语音上报功能与混响、混合录音功能暂不支持同时使用"
#endif
///<<<<所有宏定义不要在编译警告后面定义！！！！！！！！！！！！！！！！！！！！！！！！！！
///<<<<所有宏定义不要在编译警告后面定义！！！！！！！！！！！！！！！！！！！！！！！！！！
