...
// //第二组
//     extern const struct adkey_platform_data adkey_data2;
//     extern struct key_driver_para adkey_scan_para2;
//     err = adkey2_init(&adkey_data2);
//     if (err == 0) {
//          printf("key2_driver_init");
//         sys_s_hi_timer_add((void *)&adkey_scan_para2, key_driver_scan, adkey_scan_para2.scan_time); //注册按键扫描定时器
//     }
